...
export RBAC_SERVER_APP_NAME="AKSAADServer01"
export RBAC_SERVER_APP_URL="http://aksaadserver01"
# on mac doesn't work, only use on linux:
...
echo "The Azure Active Directory application has been created. An Azure AD Administrator must go the Azure portal an click the `Grant permissions` button for this app."
...
echo "Creating Azure Active Directory Client App..."
sh create-aad-client-app.sh